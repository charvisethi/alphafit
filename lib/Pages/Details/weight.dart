import 'package:fitness_app/Pages/Details/activity.dart';
...
class Weight_Page extends StatefulWidget {
  const Weight_Page({Key? key}) : super(key: key);

  @override
  State<Weight_Page> createState() => _Weight_PageState();
}

class _Weight_PageState extends State<Weight_Page> {
  bool onSelect = true;
  @override
